...
public class ReadActivity {
	...
	public void readEntities() {
		...
		Query<User> queryUsers = persistenceManager
				.newQuery("SELECT FROM com.haw_hamburg.de.objectMapping.dataNucleus.entities.User ");
		users = queryUsers.executeList();
		Query<Post> queryPosts = persistenceManager
				.newQuery("SELECT FROM com.haw_hamburg.de.objectMapping.dataNucleus.entities.Post ");
		posts = queryPosts.executeList();
		Query<Comment> queryComments = persistenceManager
				.newQuery("SELECT FROM com.haw_hamburg.de.objectMapping.dataNucleus.entities.Comment ");
